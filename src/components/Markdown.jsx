        ...
        return (<div>
            ...
            <div>
                <div className="editor">
                    ...
                    <textarea id="editor" name="editor" rows="10" cols="60" form="preview" input="input" type="text" value={this.state.value} onChange={this.handleChange}></textarea>
                    <form>
